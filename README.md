...
## Workflow
 ...
 - IMPORTANT: read the tutorial! If you are NOT an archaeologist, you need to click the 'Rules' button and modify the settings there according to your field of interest!
